...
\begin{figure*}[htb]
  ...
  \begin{center}
      \begin{tabular}{ccc}
          \subfigure[]{\resizebox{0.3\textwidth}{!}{\includegraphics{asset/doctor_gui/frontend_chat_browse.png}}}
          \subfigure[]{\resizebox{0.3\textwidth}{!}{\includegraphics{asset/doctor_gui/frontend_chat_show.png}}}
          \subfigure[]{\resizebox{0.3\textwidth}{!}{\includegraphics{asset/doctor_gui/frontend_chat_reply.png}}}
      \end{tabular}
